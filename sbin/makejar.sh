...
./repo-aws/ignite-aws-1.4.0-SNAPSHOT.jar
./repo-core/ignite-core-1.4.0-SNAPSHOT.jar
./repo-indexing/ignite-indexing-1.4.0-SNAPSHOT.jar
./repo-log4j/ignite-log4j-1.4.0-SNAPSHOT.jar
./repo-scalar/ignite-scalar-1.4.0-SNAPSHOT.jar
./repo-spring/ignite-spring-1.4.0-SNAPSHOT.jar
./repo-spark/ignite-spark-1.4.0-SNAPSHOT.jar
